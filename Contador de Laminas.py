...
def Bienvenida():
    print(
        "Bienvenido(a) a su gestor de láminas para el álbum \n "
        +"Panini Rusia 2018. Escriba 'AYUDA'para ver un resumen \n "
    ...
    if x != "AYUDA":
        ...
        print("Puede usar las siguientes funciones: \n"
               + "Agregar(Número de lámina) para agregar una sola lámina \n"
               + "AgregarV() para introducir varias láminas al mismo tiempo \n"
               + "Quitar(Número de lámina) si desea quitar una lámina de su lista \n"
               + "Faltan() para vercuantas láminas le faltan para llenar su álbum \n"
               + "Repetidas() para ver sus láminas repetidas \n"
               + "Describir(Número de lámina) si desea la descripción de una lámina")
